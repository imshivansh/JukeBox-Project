...
public class QuestionRepository implements IQuestionRepository {
    ...
    public List<Question> findAll() {
         List<Question>list = questionMap.values().stream().collect(Collectors.toList());
         return list;
    }
    ...
    public List<Question> findAllQuestionLevelWise(Level level) {
        List<Question>list = questionMap.values().stream().filter(c->c.getLevel().equals(level)).collect(Collectors.toList());
    return list;
    }
