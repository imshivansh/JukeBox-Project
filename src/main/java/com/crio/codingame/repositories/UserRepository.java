...
public class UserRepository implements IUserRepository{
    ...
    @Override
    public Optional<User> findByName(String name) throws UserNotFoundException {
        return userMap.values().stream().filter(c->c.getName().equals(name)).findFirst();
    }
